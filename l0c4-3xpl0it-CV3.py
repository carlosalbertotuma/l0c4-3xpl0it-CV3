...
def main():
    ...
    github_query = f"{module_name} exploit"
    ...
    # Search for files containing the specified tag in nuclei-templates
    output = subprocess.run(["grep", "-iRl", f"tags: *{module_name}*", "../.local/nuclei-templates/"], capture_output=True)
